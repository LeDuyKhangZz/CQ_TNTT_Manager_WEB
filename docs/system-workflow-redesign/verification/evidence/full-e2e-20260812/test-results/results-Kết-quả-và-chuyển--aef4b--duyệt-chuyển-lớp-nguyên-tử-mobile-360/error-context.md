...
Locator: getByRole('heading', { name: 'Giuse Em E2E 1-1', exact: true }).locator('xpath=ancestor::div[contains(@class,\'rounded-lg\')][1]').getByText('Ghi chú nội bộ mobile-360-1786516335287', { exact: true })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Giuse Em E2E 1-1', exact: true }).locator('xpath=ancestor::div[contains(@class,\'rounded-lg\')][1]').getByText('Ghi chú nội bộ mobile-360-1786516335287', { exact: true })
...
- main:
  ...
  - link "Xuất Excel":
    - /url: /results/25126251-1ed9-496c-8a4f-18353f0fb4a4/export?format=xlsx
  - link "Xuất PDF":
    - /url: /results/25126251-1ed9-496c-8a4f-18353f0fb4a4/export?format=pdf
  - button "Khóa bảng điểm"
  - status: "Thành công: Đã ẩn cột “Điểm công bố mobile-360-1786516335287”. Điểm vẫn còn nguyên; hiện lại được ở mục “Cột đã ẩn”."
  ...
  - text: Tên cột
  - textbox "Tên cột": Điểm công bố mobile-360-1786516335287
  - text: Ngày
  - textbox "Ngày"
  - text: Hệ số
  - spinbutton "Hệ số": "2"
  ...
  - textbox "Tên cột": Điểm nội bộ mobile-360-1786516335287
  - text: Ngày
  - textbox "Ngày"
  - text: Hệ số
  - spinbutton "Hệ số": "1"
  ...
  - combobox "Chọn cột điểm để nhập":
    - option "Điểm công bố mobile-360-1786516335287"
    - option "Điểm nội bộ mobile-360-1786516335287" [selected]
  - heading "Nhập điểm" [level=2]
  - heading "Điểm nội bộ mobile-360-1786516335287" [level=3]
  - paragraph: Không ghi ngày · hệ số 1
  - text: Nội bộ
  - table "Nhập điểm Điểm nội bộ mobile-360-1786516335287":
    - caption: Nhập điểm Điểm nội bộ mobile-360-1786516335287
    - rowgroup:
    ...
    - rowgroup:
      - row "Anna Em E2E 1-4":
        ...
        - cell:
          - spinbutton "Điểm Anna Em E2E 1-4"
        - cell:
          - textbox "Ghi chú Anna Em E2E 1-4"
      - row "Giuse Em E2E 1-1":
        - rowheader "Giuse Em E2E 1-1"
        - cell:
          - spinbutton "Điểm Giuse Em E2E 1-1"
        - cell:
          - textbox "Ghi chú Giuse Em E2E 1-1"
      - row "Maria Em E2E 1-2":
        - rowheader "Maria Em E2E 1-2"
        - cell:
          - spinbutton "Điểm Maria Em E2E 1-2"
        - cell:
          - textbox "Ghi chú Maria Em E2E 1-2"
      - row "Phaolô Em E2E 1-5":
        - rowheader "Phaolô Em E2E 1-5"
        - cell:
          - spinbutton "Điểm Phaolô Em E2E 1-5"
        - cell:
          - textbox "Ghi chú Phaolô Em E2E 1-5"
      - row "Phêrô Em E2E 1-3":
        - rowheader "Phêrô Em E2E 1-3"
        - cell:
          - spinbutton "Điểm Phêrô Em E2E 1-3"
        - cell:
          - textbox "Ghi chú Phêrô Em E2E 1-3"
      - row "Têrêsa Em E2E 1-6":
        - rowheader "Têrêsa Em E2E 1-6"
        - cell:
          - spinbutton "Điểm Têrêsa Em E2E 1-6"
        - cell:
          - textbox "Ghi chú Têrêsa Em E2E 1-6"
  - button "Lưu điểm Điểm nội bộ mobile-360-1786516335287"
  ...
  - combobox "Cột điểm":
    ...
    - option "Điểm công bố mobile-360-1786516335287"
    - option "Điểm nội bộ mobile-360-1786516335287"
