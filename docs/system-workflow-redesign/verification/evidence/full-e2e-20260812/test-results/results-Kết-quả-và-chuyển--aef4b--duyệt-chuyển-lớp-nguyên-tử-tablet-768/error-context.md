...
Locator: getByRole('button', { name: 'Lưu điểm Điểm công bố tablet-768-1786516929758' })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Lưu điểm Điểm công bố tablet-768-1786516929758' })
...
- main:
  ...
  - link "← Danh sách lớp":
    - /url: /results
  - text: Đang mở 0 cột điểm · 6 thiếu nhi
  - link "Xuất Excel":
    - /url: /results/fb6222c7-fe70-4f9e-b0d8-9e93d2b2b7da/export?format=xlsx
  - link "Xuất PDF":
    - /url: /results/fb6222c7-fe70-4f9e-b0d8-9e93d2b2b7da/export?format=pdf
  ...
  - text: Hệ số
  - spinbutton "Hệ số": "1"
  - button "Đang thêm…" [disabled]
  - status: "Thành công: Đã thêm cột điểm."
  - text: Lớp chưa tạo cột điểm. Đây là trạng thái hợp lệ; không có cột bắt buộc.
