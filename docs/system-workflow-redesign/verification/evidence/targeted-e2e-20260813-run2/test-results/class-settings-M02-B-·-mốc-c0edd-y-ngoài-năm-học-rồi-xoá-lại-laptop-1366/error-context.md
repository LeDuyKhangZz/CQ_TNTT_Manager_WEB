...
- main:
  ...
  - list:
    - listitem: 16 ghi danh đang mở
    - listitem: 1 bảng điểm chưa khoá
  ...
  - button "Vô hiệu hóa"
  - button "Xóa tài khoản"
  - paragraph: Phụ huynh E2E 1
  - paragraph: 84919999991 · Phụ huynh
  - text: Đang hoạt động
  - textbox "Tên đăng nhập Phụ huynh E2E 1": "84919999991"
  - button "Lưu username"
  - textbox "Mật khẩu mới Phụ huynh E2E 1":
    - /placeholder: Mật khẩu mới, ít nhất 8 ký tự
  - button "Đặt mật khẩu"
  - button "Tạo mật khẩu ngẫu nhiên"
  - button "Vô hiệu hóa"
  - button "Xóa tài khoản"
  - paragraph: Phụ huynh E2E 2
  - paragraph: 84919999992 · Phụ huynh
  - text: Đang hoạt động
  - textbox "Tên đăng nhập Phụ huynh E2E 2": "84919999992"
  - button "Lưu username"
  - textbox "Mật khẩu mới Phụ huynh E2E 2":
    - /placeholder: Mật khẩu mới, ít nhất 8 ký tự
  - button "Đặt mật khẩu"
  - button "Tạo mật khẩu ngẫu nhiên"
  - button "Vô hiệu hóa"
  - button "Xóa tài khoản"
  - paragraph: Cha phó Phêrô
  - paragraph: CHAPHO · Cha phó/Tuyên úy
  - text: Đang hoạt động
  - textbox "Tên đăng nhập Cha phó Phêrô": CHAPHO
  - button "Lưu username"
  - textbox "Mật khẩu mới Cha phó Phêrô":
    - /placeholder: Mật khẩu mới, ít nhất 8 ký tự
  - button "Đặt mật khẩu"
  - button "Tạo mật khẩu ngẫu nhiên"
  - button "Vô hiệu hóa"
  - button "Xóa tài khoản"
  - paragraph: Cha sở Giuse
  - paragraph: CHASO · Cha sở
  - text: Đang hoạt động
  - textbox "Tên đăng nhập Cha sở Giuse": CHASO
  - button "Lưu username"
  - textbox "Mật khẩu mới Cha sở Giuse":
    - /placeholder: Mật khẩu mới, ít nhất 8 ký tự
  - button "Đặt mật khẩu"
  - button "Tạo mật khẩu ngẫu nhiên"
  - button "Vô hiệu hóa"
  - button "Xóa tài khoản"
  - paragraph: Nguyễn Minh An
  - paragraph: CQ0001 · Thiếu nhi
  - text: Đang hoạt động
  - textbox "Tên đăng nhập Nguyễn Minh An": CQ0001
  - button "Lưu username"
  - textbox "Mật khẩu mới Nguyễn Minh An":
    - /placeholder: Mật khẩu mới, ít nhất 8 ký tự
  - button "Đặt mật khẩu"
  - button "Tạo mật khẩu ngẫu nhiên"
  - button "Vô hiệu hóa"
  - button "Xóa tài khoản"
  - paragraph: Thiếu nhi E2E 1
  - paragraph: CQ9901 · Thiếu nhi
  - text: Đang hoạt động
  - textbox "Tên đăng nhập Thiếu nhi E2E 1": CQ9901
  - button "Lưu username"
  - textbox "Mật khẩu mới Thiếu nhi E2E 1":
    - /placeholder: Mật khẩu mới, ít nhất 8 ký tự
  - button "Đặt mật khẩu"
  - button "Tạo mật khẩu ngẫu nhiên"
  - button "Vô hiệu hóa"
