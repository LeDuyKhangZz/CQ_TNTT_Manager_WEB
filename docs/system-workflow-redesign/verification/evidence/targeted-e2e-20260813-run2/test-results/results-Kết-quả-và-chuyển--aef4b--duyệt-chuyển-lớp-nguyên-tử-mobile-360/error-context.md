...
Locator: getByRole('button', { name: 'Lưu điểm Điểm nội bộ mobile-360-1786603329272' })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Lưu điểm Điểm nội bộ mobile-360-1786603329272' })
...
- main:
  ...
  - link "Xuất Excel":
    - /url: /results/f678f3d9-d1f7-4639-848d-e773b1ec5fce/export?format=xlsx
  - link "Xuất PDF":
    - /url: /results/f678f3d9-d1f7-4639-848d-e773b1ec5fce/export?format=pdf
  ...
  - text: Tên cột
  - textbox "Tên cột": Điểm công bố mobile-360-1786603329272
  - text: Ngày
  - textbox "Ngày"
  - text: Hệ số
  - spinbutton "Hệ số": "2"
  ...
  - textbox "Tên cột": Điểm nội bộ mobile-360-1786603329272
  - text: Ngày
  - textbox "Ngày"
  - text: Hệ số
  - spinbutton "Hệ số": "1"
  ...
  - combobox "Chọn cột điểm để nhập":
    - option "Điểm công bố mobile-360-1786603329272" [selected]
    - option "Điểm nội bộ mobile-360-1786603329272"
  - heading "Nhập điểm" [level=2]
  - heading "Điểm công bố mobile-360-1786603329272" [level=3]
  - paragraph: Không ghi ngày · hệ số 2
  - text: Đã công bố
  - table "Nhập điểm Điểm công bố mobile-360-1786603329272":
    - caption: Nhập điểm Điểm công bố mobile-360-1786603329272
    - rowgroup:
  ...
  - button "Lưu điểm Điểm công bố mobile-360-1786603329272"
  ...
  - combobox "Cột điểm":
    ...
    - option "Điểm công bố mobile-360-1786603329272"
    - option "Điểm nội bộ mobile-360-1786603329272"
