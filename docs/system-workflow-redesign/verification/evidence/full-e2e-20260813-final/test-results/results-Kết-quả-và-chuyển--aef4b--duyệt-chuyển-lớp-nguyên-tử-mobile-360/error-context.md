...
Locator: getByRole('button', { name: 'Lưu điểm Điểm nội bộ mobile-360-1786604024038' })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Lưu điểm Điểm nội bộ mobile-360-1786604024038' })
...
- main:
  ...
  - link "Xuất Excel":
    - /url: /results/bbc88ad5-6915-4ce6-bf13-65d22c0f3881/export?format=xlsx
  - link "Xuất PDF":
    - /url: /results/bbc88ad5-6915-4ce6-bf13-65d22c0f3881/export?format=pdf
  ...
  - text: Tên cột
  - textbox "Tên cột": Điểm công bố mobile-360-1786604024038
  - text: Ngày
  - textbox "Ngày"
  - text: Hệ số
  - spinbutton "Hệ số": "2"
  ...
  - textbox "Tên cột": Điểm nội bộ mobile-360-1786604024038
  - text: Ngày
  - textbox "Ngày"
  - text: Hệ số
  - spinbutton "Hệ số": "1"
  ...
  - combobox "Chọn cột điểm để nhập":
    - option "Điểm công bố mobile-360-1786604024038" [selected]
    - option "Điểm nội bộ mobile-360-1786604024038"
  - heading "Nhập điểm" [level=2]
  - heading "Điểm công bố mobile-360-1786604024038" [level=3]
  - paragraph: Không ghi ngày · hệ số 2
  - text: Đã công bố
  - table "Nhập điểm Điểm công bố mobile-360-1786604024038":
    - caption: Nhập điểm Điểm công bố mobile-360-1786604024038
    - rowgroup:
  ...
  - button "Lưu điểm Điểm công bố mobile-360-1786604024038"
  ...
  - combobox "Cột điểm":
    ...
    - option "Điểm công bố mobile-360-1786604024038"
    - option "Điểm nội bộ mobile-360-1786604024038"
